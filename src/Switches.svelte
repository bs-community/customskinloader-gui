<script lang="ts">
  ...
  export let enableTransparentSkin = true
  export let ignoreHttpsCertificate = false
  export let enableUpdateSkull = false
  export let enableLocalProfileCache = false
  export let enableCacheAutoClean = false
